...
function Profile() {
    ...
    // ---- EARLY RETURN ONLY AFTER all hooks + handlers ----
    if (loading) {
            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
                ...
                <form onSubmit={handleSaveChanges}>
                    <div className="flex flex-col items-center mb-6">
                        <img
                           src={imageFile ? URL.createObjectURL(imageFile) : profileData.profilePicUrl || `https://ui-avatars.com/api/?name=${profileData.name || 'User'}&background=random`}
                           alt="Profile"
